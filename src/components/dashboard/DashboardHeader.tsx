              ...
              >
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8 text-left">
                  <div className="space-y-4">
                    <BreakdownRow label="Liquidità immediata" value={liquid} icon={<Droplets size={14} />} color="text-blue-400" sub="Conti Corrente + Contanti" tooltip="Saldo disponibile subito." />
                    <BreakdownRow label="Risparmi" value={savings} icon={<PiggyBank size={14} />} color="text-[var(--income)]" sub="Conti Deposito" tooltip="Saldo dei conti Deposito." />
                    <BreakdownRow label="Investimenti" value={investments} icon={<TrendingUp size={14} />} color="text-purple-400" sub="Conti tipo Investimento" tooltip="Valore degli investimenti." />
                  </div>
                  <div className="space-y-4">
                    <BreakdownRow label="Accantonato Obiettivi" value={-earmarked} icon={<Target size={14} />} color="text-[var(--warning)]" sub="Fondi bloccati" tooltip="Fondi destinati agli obiettivi." />
                    <BreakdownRow label="Debiti e Passività" value={debts} icon={<AlertTriangle size={14} />} color="text-[var(--expense)]" sub="Mutui, Prestiti" tooltip="Denaro da restituire." />
                    <div className="pt-4 mt-4 border-t border-[var(--border-subtle)]">
                      <div className="flex justify-between items-center">
                        <Tooltip content="Liquidità immediata meno gli importi già destinati agli Obiettivi." side="top">
                        ...
                        <div className="text-xl font-mono font-black text-[var(--accent)]">
      ...
      <div className="flex justify-center md:justify-start">
        <div className={cn(
          ...
          <div className="text-left">
            ...
            <div className="text-[9px] text-[var(--fg-muted)] font-medium mt-1 italic flex items-center gap-1">
              {available < 0
                ? <>⚠ Obiettivi (<Amount value={earmarked} hideLabel />) eccedono liquidità</>
                : <>Sottratti <Amount value={Math.abs(earmarked)} hideLabel /> destinati agli obiettivi</>}
            </div>
          </div>
        </div>
      </div>
  ...
  return (
    <div className="flex items-start justify-between group">
      ...
      <div className="font-mono font-bold text-sm">
        <Amount value={value} className={value < 0 ? "text-[var(--expense)]" : "text-[var(--fg-primary)]"} hideLabel />
      </div>
    </div>
  )
}
